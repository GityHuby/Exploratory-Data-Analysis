...
When loading the dataset into R, the following has been considered:

The dataset has 2,075,259 rows and 9 columns. 

data from the dates 2007-02-01 and 2007-02-02 were used.

The dataset missing values are coded as ?.

Making Plots

The plots based on the projects were recontructed using the base plotting system.
